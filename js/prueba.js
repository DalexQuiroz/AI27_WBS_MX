...
function traer() {
  ...
  console.log("La función se ejecutó automáticamente cada 3 minutos y 55 segundos.");
}

// Configura la ejecución automática cada 3 minutos y 55 segundos (3  60  1000 + 55 * 1000 milisegundos)
setInterval(traer, (3 * 60 * 1000) + (55 * 1000));
...
function enviarDatos() {
  // Tu lógica o código aquí
  console.log("La función se ejecutó automáticamente cada 4 minutos.");
}

// Configura la ejecución automática cada 4 minutos (4  60  1000 milisegundos)
setInterval(enviarDatos, (4 * 60 * 1000));
function enviarDatos() {
